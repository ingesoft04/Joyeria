export class ApiController {
  ...
  async bulkProducts(req,res) { this.adminService.authorize(req.headers.authorization); const body=await this.body(req); this.json(res,200,await this.adminService.bulkUpdate(body.products,body.mode)); }
