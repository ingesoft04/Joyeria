export class ApiController {
  ...
  async bulkProducts(req,res) { this.adminService.authorize(req.headers.authorization); this.json(res,200,{updated:(await this.adminService.bulkUpdate((await this.body(req)).products)).length}); }
